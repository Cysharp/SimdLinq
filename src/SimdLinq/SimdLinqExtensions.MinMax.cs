...
{
    /// <summary>
    /// Returns the minimum and maximum values in a collection of <see cref="byte"/> values using SIMD acceleration.
    /// </summary>
    /// <param name="source">A collection of <see cref="byte"/> values to determine the minimum and maximum value of.</param>
    /// <returns>A tuple of the minimum and maximum values in the collection.</returns>
    ...
    /// <summary>
    /// Returns the minimum and maximum values in a collection of <see cref="sbyte"/> values using SIMD acceleration.
    /// </summary>
    /// <param name="source">A collection of <see cref="sbyte"/> values to determine the minimum and maximum value of.</param>
    /// <returns>A tuple of the minimum and maximum values in the collection.</returns>
    /// <exception cref="ArgumentNullException"><paramref name="source"/> is null.</exception>
    /// <exception cref="InvalidOperationException"><paramref name="source"/> contains no elements.</exception>
    ...
    /// <summary>
    /// Returns the minimum and maximum values in a collection of <see cref="short"/> values using SIMD acceleration.
    /// </summary>
    /// <param name="source">A collection of <see cref="short"/> values to determine the minimum and maximum value of.</param>
    /// <returns>A tuple of the minimum and maximum values in the collection.</returns>
    /// <exception cref="ArgumentNullException"><paramref name="source"/> is null.</exception>
    /// <exception cref="InvalidOperationException"><paramref name="source"/> contains no elements.</exception>
    ...
    /// <summary>
    /// Returns the minimum and maximum values in a collection of <see cref="ushort"/> values using SIMD acceleration.
    /// </summary>
    /// <param name="source">A collection of <see cref="ushort"/> values to determine the minimum and maximum value of.</param>
    /// <returns>A tuple of the minimum and maximum values in the collection.</returns>
    /// <exception cref="ArgumentNullException"><paramref name="source"/> is null.</exception>
    /// <exception cref="InvalidOperationException"><paramref name="source"/> contains no elements.</exception>
    ...
    /// <summary>
    /// Returns the minimum and maximum values in a collection of <see cref="int"/> values using SIMD acceleration.
    /// </summary>
    /// <param name="source">A collection of <see cref="int"/> values to determine the minimum and maximum value of.</param>
    /// <returns>A tuple of the minimum and maximum values in the collection.</returns>
    /// <exception cref="ArgumentNullException"><paramref name="source"/> is null.</exception>
    /// <exception cref="InvalidOperationException"><paramref name="source"/> contains no elements.</exception>
    ...
    /// <summary>
    /// Returns the minimum and maximum values in a collection of <see cref="uint"/> values using SIMD acceleration.
    /// </summary>
    /// <param name="source">A collection of <see cref="uint"/> values to determine the minimum and maximum value of.</param>
    /// <returns>A tuple of the minimum and maximum values in the collection.</returns>
    /// <exception cref="ArgumentNullException"><paramref name="source"/> is null.</exception>
    /// <exception cref="InvalidOperationException"><paramref name="source"/> contains no elements.</exception>
    ...
    /// <summary>
    /// Returns the minimum and maximum values in a collection of <see cref="long"/> values using SIMD acceleration.
    /// </summary>
    /// <param name="source">A collection of <see cref="long"/> values to determine the minimum and maximum value of.</param>
    /// <returns>A tuple of the minimum and maximum values in the collection.</returns>
    /// <exception cref="ArgumentNullException"><paramref name="source"/> is null.</exception>
    /// <exception cref="InvalidOperationException"><paramref name="source"/> contains no elements.</exception>
    ...
    /// <summary>
    /// Returns the minimum and maximum values in a collection of <see cref="ulong"/> values using SIMD acceleration.
    /// </summary>
    /// <param name="source">A collection of <see cref="ulong"/> values to determine the minimum and maximum value of.</param>
    /// <returns>A tuple of the minimum and maximum values in the collection.</returns>
    /// <exception cref="ArgumentNullException"><paramref name="source"/> is null.</exception>
    /// <exception cref="InvalidOperationException"><paramref name="source"/> contains no elements.</exception>
    ...
    /// <summary>
    /// Returns the minimum and maximum values in a collection of <see cref="float"/> values using SIMD acceleration.
    /// </summary>
    ...
    /// <param name="source">A collection of <see cref="float"/> values to determine the minimum and maximum value of.</param>
    /// <returns>A tuple of the minimum and maximum values in the collection.</returns>
    /// <exception cref="ArgumentNullException"><paramref name="source"/> is null.</exception>
    /// <exception cref="InvalidOperationException"><paramref name="source"/> contains no elements.</exception>
    ...
    /// <summary>
    /// Returns the minimum and maximum values in a collection of <see cref="double"/> values using SIMD acceleration.
    /// </summary>
    /// <remarks>This method does not check for <see cref="float.NaN"/> <see cref="float"/>/<see cref="double"/> values and should not be used when <paramref name="source"/> may contain one.</remarks>
    /// <param name="source">A collection of <see cref="double"/> values to determine the minimum and maximum value of.</param>
    /// <returns>A tuple of the minimum and maximum values in the collection.</returns>
    /// <exception cref="ArgumentNullException"><paramref name="source"/> is null.</exception>
    /// <exception cref="InvalidOperationException"><paramref name="source"/> contains no elements.</exception>
