...
{
    /// <summary>
    /// Computes the sum of a collection of <see cref="int"/> values using SIMD acceleration.
    /// </summary>
    /// <remarks>
    /// <para>Note that unlike Linq.Sum this method is unchecked and will not throw an <see cref="OverflowException"/>.</para>
    /// </remarks>
    /// <param name="source">A collection of <see cref="int"/> values to calculate the sum of.</param>
    ...
    /// <summary>
    /// Computes the sum of a collection of <see cref="uint"/> values using SIMD acceleration.
    /// </summary>
    /// <remarks>
    /// <para>Note that unlike Linq.Sum this method is unchecked and will not throw an <see cref="OverflowException"/>.</para>
    /// </remarks>
    /// <param name="source">A collection of <see cref="uint"/> values to calculate the sum of.</param>
    /// <returns>The sum of the values in the collection.</returns>
    /// <exception cref="ArgumentNullException"><paramref name="source"/> is null.</exception>
    ...
    /// <summary>
    /// Computes the sum of a collection of <see cref="long"/> values using SIMD acceleration.
    /// </summary>
    /// <remarks>
    /// <para>Note that unlike Linq.Sum this method is unchecked and will not throw an <see cref="OverflowException"/>.</para>
    /// </remarks>
    /// <param name="source">A collection of <see cref="long"/> values to calculate the sum of.</param>
    /// <returns>The sum of the values in the collection.</returns>
    /// <exception cref="ArgumentNullException"><paramref name="source"/> is null.</exception>
    ...
    /// <summary>
    /// Computes the sum of a collection of <see cref="ulong"/> values using SIMD acceleration.
    /// </summary>
    /// <remarks>
    /// <para>Note that unlike Linq.Sum this method is unchecked and will not throw an <see cref="OverflowException"/>.</para>
    /// </remarks>
    /// <param name="source">A collection of <see cref="ulong"/> values to calculate the sum of.</param>
    /// <returns>The sum of the values in the collection.</returns>
    /// <exception cref="ArgumentNullException"><paramref name="source"/> is null.</exception>
    ...
    /// <summary>
    /// Computes the sum of a collection of <see cref="float"/> values using SIMD acceleration.
    /// </summary>
    /// <remarks>
    /// <para>Note that unlike Linq.Sum this method is unchecked and will not throw an <see cref="OverflowException"/>.</para>
    ...
    /// </remarks>
    /// <param name="source">A collection of <see cref="float"/> values to calculate the sum of.</param>
    /// <returns>The sum of the values in the collection.</returns>
    /// <exception cref="ArgumentNullException"><paramref name="source"/> is null.</exception>
    ...
    /// <summary>
    /// Computes the sum of a collection of <see cref="double"/> values using SIMD acceleration.
    /// </summary>
    /// <remarks>
    /// <para>Note that unlike Linq.Sum this method is unchecked and will not throw an <see cref="OverflowException"/>.</para>
    /// <para>Unlike Linq, the order for the sum calculation is not sequential, leading to slight differences in floating-point operations and the resulting value. While this difference is minimal you should not use this method if you require the same result as Linq.Sum.</para>
    /// </remarks>
    /// <param name="source">A collection of <see cref="double"/> values to calculate the sum of.</param>
    /// <returns>The sum of the values in the collection.</returns>
    /// <exception cref="ArgumentNullException"><paramref name="source"/> is null.</exception>
